    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200 transition-colors duration-300">
      ...
      <section className="relative py-20 md:py-28 bg-slate-900 text-white overflow-hidden">
        ...
        <div className="container-custom relative z-10 max-w-4xl text-center space-y-6">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-accent text-xs font-bold uppercase tracking-wider">
          ...
          <p className="text-base md:text-lg text-slate-355 leading-relaxed max-w-2xl mx-auto">
