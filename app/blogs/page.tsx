                  ...
                  <div className="space-y-8">
                    {filteredBlogs.map((blog) => (
                      <motion.article
                        ...
                        viewport={{ once: true }}
                        className="group flex flex-col md:flex-row gap-6 p-5 rounded-2xl border border-slate-100 dark:border-slate-850 bg-white dark:bg-slate-900/40 hover:shadow-card transition-all"
                      >
                        {/* Thumbnail */}
